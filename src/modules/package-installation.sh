...
DESKTOP_PACKAGES=(
    ...
    # All recommended packages from mmdebstrap
    "e2fsprogs-l10n" "cups" "cups-client" "cups-filters" "xserver-xephyr"
    "avahi-daemon" "iio-sensor-proxy" "modemmanager" "cracklib-runtime"
    "cups-pk-helper" "fwupd" "gnome-bluetooth-sendto" "gnome-control-center-faces"
    "gnome-online-accounts" "gnome-remote-desktop" "gnome-user-docs" "ibus"
    "libcanberra-pulse" "network-manager-gnome" "power-profiles-daemon" "rygel"
    "system-config-printer-common" "gnome-startup-applications" "bolt"
    "evolution-data-server" "gkbd-capplet" "switcheroo-control" "xserver-xorg-legacy"
    "nautilus-extension-gnome-terminal" "gnupg-l10n" "gpg-wks-client" "gstreamer1.0-x"
    "im-config" "alsa-ucm-conf" "alsa-topology-conf" "aspell-en" "libcanberra-gtk3-module"
    "enchant-2" "libgdk-pixbuf2.0-bin" "libgl1-amber-dri" "libgphoto2-l10n"
    "fonts-droid-fallback" "gstreamer1.0-gl" "libgtk-3-bin" "libgtk-4-bin"
    "libheif-plugin-aomenc" "usbmuxd" "libldap-common" "libpaper-utils"
    "libpipewire-0.3-common" "sane-airscan" "sane-utils" "ipp-usb" "mesa-vulkan-drivers"
    "gvfs-backends" "ppp" "dnsmasq-base" "network-manager-pptp" "wireless-regdb"
    "appstream" "packagekit-tools" "rtkit" "apport" "unattended-upgrades" "gnome-keyring"
    "apport-gtk" "apt-config-icons-hidpi" "baobab" "bluez" "bluez-cups" "brltty"
    "cloud-init" "cups-bsd" "eog" "evince" "fonts-liberation" "fonts-noto-cjk"
    "fonts-noto-color-emoji" "fonts-noto-core" "fonts-ubuntu" "fwupd-signed" "gamemode"
    "gir1.2-gmenu-3.0" "gnome-accessibility-themes" "gnome-characters" "gnome-clocks"
    "gnome-disk-utility" "gnome-font-viewer" "gnome-initial-setup" "gnome-logs"
    "gnome-power-manager" "gnome-text-editor" "gsettings-ubuntu-schemas" "gvfs-fuse"
    "hplip" "ibus-gtk" "ibus-gtk3" "ibus-table" "kerneloops" "laptop-detect"
    "libnss-mdns" "libpam-fprintd" "libpam-gnome-keyring" "libpam-sss"
    "libproxy1-plugin-gsettings" "libproxy1-plugin-networkmanager" "libwmf0.2-7-gtk"
    "memtest86+" "mousetweaks" "nautilus-sendto" "network-manager-config-connectivity-ubuntu"
    "network-manager-openvpn-gnome" "network-manager-pptp-gnome" "orca" "pcmciautils"
    "plymouth-theme-spinner" "policykit-desktop-privileges" "printer-driver-brlaser"
    "printer-driver-c2esp" "printer-driver-foo2zjs" "printer-driver-m2300w"
    "printer-driver-min12xxw" "printer-driver-ptouch" "printer-driver-pxljr"
    "printer-driver-sag-gdi" "printer-driver-splix" "seahorse" "speech-dispatcher"
    "systemd-oomd" "ubuntu-docs" "ubuntu-report" "whoopsie" "xcursor-themes" "xdg-utils"
    "yaru-theme-gtk" "yaru-theme-icon" "yaru-theme-sound" "xbitmaps" "luit"
    "xfonts-scalable" "xserver-xorg-video-all" "xcvt" "xserver-xorg-input-wacom"
    "docbook-xml"
    
    # Additional useful apps
    "totem" "cheese" "screenshot"
)
